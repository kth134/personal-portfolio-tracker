      ...
      <div className="pt-8 border-t">
        <Accordion type="multiple" value={openItems} onValueChange={setOpenItems}>
          {[...data.subPortfolios]
            ...
            const sortedItems = [...items].sort((a,b) => { const aV = sortCol === 'ticker' ? a.ticker : a[sortCol]; const bV = sortCol === 'ticker' ? b.ticker : b[sortCol]; const r = (aV || 0) < (bV || 0) ? -1 : (aV || 0) > (bV || 0) ? 1 : 0; return sortDir === 'asc' ? r : -r; });
            return (
