    ...
    <div className="flex flex-col gap-6 overflow-x-hidden">
      <div className={cn('order-1 grid gap-6 md:grid-cols-3', chartSlices.length === 1 ? 'md:items-stretch' : 'md:items-start')}>
        ...
        >
          ...
          <div className={cn('flex flex-col px-4 pb-4 pt-4 sm:px-6 sm:pb-6', chartSlices.length === 1 && 'md:h-full md:flex-1')}>
            <div className="flex flex-1 flex-col gap-4 md:h-full md:justify-evenly md:gap-0">
